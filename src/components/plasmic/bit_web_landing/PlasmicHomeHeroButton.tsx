...
import sty from "./PlasmicHomeHeroButton.module.css"; // plasmic-import: _qICj0r55b2/css
...
export type PlasmicHomeHeroButton__VariantMembers = {
...
export type PlasmicHomeHeroButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicHomeHeroButton__VariantsArgs;
export const PlasmicHomeHeroButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicHomeHeroButton__ArgsType = {
  children?: React.ReactNode;
  startIcon?: React.ReactNode;
  endIcon?: React.ReactNode;
  link?: string;
};
type ArgPropType = keyof PlasmicHomeHeroButton__ArgsType;
export const PlasmicHomeHeroButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicHomeHeroButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultHomeHeroButtonProps extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
function PlasmicHomeHeroButton__RenderFunc(props: {
  variants: PlasmicHomeHeroButton__VariantsArgs;
  args: PlasmicHomeHeroButton__ArgsType;
  overrides: PlasmicHomeHeroButton__OverridesType;
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__fmq2P)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__nNRf)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicHomeHeroButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicHomeHeroButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicHomeHeroButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicHomeHeroButton__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHomeHeroButton__ArgProps,
          internalVariantPropNames: PlasmicHomeHeroButton__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicHomeHeroButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHomeHeroButton";
  } else {
    func.displayName = `PlasmicHomeHeroButton.${nodeName}`;
  }
  return func;
}

export const PlasmicHomeHeroButton = Object.assign(
  // Top-level PlasmicHomeHeroButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHomeHeroButton
    internalVariantProps: PlasmicHomeHeroButton__VariantProps,
    internalArgProps: PlasmicHomeHeroButton__ArgProps,

    useBehavior
  }
);

export default PlasmicHomeHeroButton;
/* prettier-ignore-end */
